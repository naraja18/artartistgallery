...
public class ArtistJpaService implements ArtistRepository {
    ...
    public ArrayList<Artist> getArtists() {
        List<Artist> sponsorList = artistJpaRepository.findAll();
        ArrayList<Artist> sponsors = new ArrayList<>(sponsorList);
        return sponsors;
    }
    ...
    public Artist updateArtist(int artistId, Artist artist) {
        try {
            ...
            if (artist.getGalleries() != null) {
                ...
                List<Gallery> gallerys = galleryJpaRepository.findAllById(galleryIds);
